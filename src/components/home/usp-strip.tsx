      ...
      <Container width="wide">
        <Reveal className="max-w-full sm:max-w-[80%]">
          ...
          <h2 className="mt-5 text-[1.85rem] font-semibold leading-[1.12] text-deep sm:text-display-sm sm:text-[2.6rem] sm:leading-[1.1]">
            What brings people through our door
          </h2>
          <p className="mt-4 max-w-prose text-[18px] leading-relaxed text-charcoal/75">
            From the area&rsquo;s only self-service wash to calm, careful grooming, we built this
            shop for Southwest Michigan locals and South Haven visitors who want their pets looked
            after properly.
          </p>
        </Reveal>
